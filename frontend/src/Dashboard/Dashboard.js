        ...
        <div className='flex flex-col border-white-100 border-2 h-full rounded-lg'>
          ...
          <div className='flex-shrink-0'>
            ...
            <div className='flex flex-row rounded-br-lg rounded-bl-lg bg-app-bg border-t-white-100 border-t-2'>
              ...
              <button className={`mx-2 my-3 px-3 rounded-lg border-2 border-l-2 ${sendEnabled ? 'cursor-pointer border-white-100 text-white' : 'cursor-not-allowed disabled border-gray-600 text-slate-600'}`}>
